...
export default [
    ...
    // Zod .describe() enforcement for API route files only
    {
        ...
        rules: {
            ...
            'fius-custom/require-zod-describe': [
                'error',
                {
                    exemptSchemaNames: [
    ...
    // Enforce OpenAPIHono + createRoute for server JSON routes
    {
        ...
        rules: {
            'fius-custom/require-openapi-route-contract': 'error',
            'fius-custom/require-openapi-json-error-responses': 'warn',
        },
    },
    ...
    // Prevent optional logger parameters in class constructors
    {
        ...
        rules: {
            ...
            'fius-custom/no-optional-logger-in-constructor': 'error',
        },
    },
