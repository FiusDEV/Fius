...
export class ToolManager {
    ...
    constructor(
        ...
        this.logger = logger.createChild(FiusLogComponent.TOOLS);
        ...
        this.toolExecutionContextFactory = () => {
            throw ToolError.configInvalid(
                'ToolExecutionContextFactory not configured. FiusAgent.start() must configure tool execution context before tools can run.'
            );
        };
