...
const NOOP_LIFECYCLE: FiusStoresLifecycle = {
...
export class BackendFiusStores implements FiusStores {
    private connected = false;

    constructor(
        private readonly stores: FiusStoreMap,
        private readonly lifecycle: FiusStoresLifecycle = NOOP_LIFECYCLE,
