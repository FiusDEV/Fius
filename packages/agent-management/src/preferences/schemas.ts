...
export const PreferenceLLMSchema = z
    .object({
        provider: z.string().min(1).describe('LLM provider (openai, anthropic, google, etc.)'),
...
export const PreferenceSoundsSchema = z
    .object({
        ...
        startupSoundFile: z
            ...
            .min(1)
            .optional()
            .describe('Startup sound file path relative to ~/.fius/sounds (optional)'),
        ...
        approvalSoundFile: z
            ...
            .min(1)
            .optional()
            .describe('Approval sound file path relative to ~/.fius/sounds (optional)'),
        onTaskComplete: z
            .boolean()
            .default(true)
        ...
        completeSoundFile: z
            ...
            .min(1)
            .optional()
            .describe('Completion sound file path relative to ~/.fius/sounds (optional)'),
    })
    .strict();
