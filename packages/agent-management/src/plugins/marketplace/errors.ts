...
export class MarketplaceError {
    ...
    static removeNotFound(name: string) {
        return new FiusRuntimeError(
            ...
            { name },
            'Use `fius plugin marketplace list` to see registered marketplaces'
        );
    }
    ...
    static installMarketplaceNotFound(marketplace: string) {
        return new FiusRuntimeError(
            ...
            { marketplace },
            'Use `fius plugin marketplace list` to see registered marketplaces, or `fius plugin marketplace add` to register one'
        );
    }
    ...
    static installPluginNotFound(pluginName: string, marketplace?: string) {
        ...
        return new FiusRuntimeError(
            ...
            'Use `fius plugin marketplace` to browse available plugins'
        );
    }
