...
const DUMMY_API_KEY = 'fius-chatgpt-oauth';
        ...
        server.on('request', async (request, response) => {
            try {
                ...
                response
                    ...
                    .end(
                        '<!doctype html><title>Fius ChatGPT Login</title><p>Authorization complete. You can close this window.</p>'
                    );
                settled = true;
