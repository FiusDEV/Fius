...
/**
 * Providers that use a shared env var for API keys (vs per-endpoint like custom providers).
 ...
 * - For custom providers: always save as per-model (each endpoint needs own key)
 *
