 ...
 * @see https://docs.fius.ai/api/sdk/agent-manager for full documentation
 */
...
export class AgentManager {
     ...
     * ```
     */
    async loadAgent(id: string): Promise<FiusAgent> {
