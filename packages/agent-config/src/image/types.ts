 ...
 */
export interface FiusHostContext<
 ...
 */
export interface ImageResolutionContext<THostContext extends FiusHostContext = FiusHostContext> {
    agentId: string;
 ...
 */
export type FiusImageRuntimeConfigOverrides = Partial<Omit<FiusAgentConfigInput, 'agentId'>>;
...
export interface SkillSourceFactory<THostContext extends FiusHostContext = FiusHostContext> {
 ...
 */
export interface FiusImage<THostContext extends FiusHostContext = FiusHostContext> {
    /**
    ...
    ): FiusImageRuntimeConfigOverrides | undefined;
}
