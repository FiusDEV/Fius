...
const logSchedulerError = (
    ...
    agent.logger.error(message, {
        ...
        code: error instanceof FiusRuntimeError ? error.code : undefined,
    });
};
...
type ScheduleIdParamInput = { param: z.input<typeof ScheduleIdParamSchema> };

type ListRouteSchema = OpenAPIRouteSchema<typeof listRoute, {}>;
type CreateRouteSchema = OpenAPIRouteSchema<
    typeof createRouteDef,
    { json: z.input<typeof CreateScheduleSchema> }
>;
type UpdateRouteSchema = OpenAPIRouteSchema<
    typeof updateRoute,
    ScheduleIdParamInput & { json: z.input<typeof UpdateScheduleSchema> }
>;
type DeleteRouteSchema = OpenAPIRouteSchema<typeof deleteRoute, ScheduleIdParamInput>;
type TriggerRouteSchema = OpenAPIRouteSchema<typeof triggerRoute, ScheduleIdParamInput>;

export type SchedulesRouterSchema =
    | ListRouteSchema
    | CreateRouteSchema
    | UpdateRouteSchema
    | DeleteRouteSchema
