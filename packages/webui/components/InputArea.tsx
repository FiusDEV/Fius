...
import type { ResourceMetadata as UIResourceMetadata } from '@fiusdev/core';
import type { SupportedFileType } from '@fiusdev/llm';
...
export default React.memo(function InputArea({
    ...
    const LARGE_PASTE_THRESHOLD = 20000;
                            ...
                            <div className="flex-auto overflow-y-auto relative">
                                {fontsReady ? (
                                    <TextareaAutosize
                                        ...
                                        onPaste={handlePaste}
                                        placeholder="Ask Fius anything... Type @ for resources, / for prompts, # for memories"
                                        minRows={1}
                                        maxRows={8}
