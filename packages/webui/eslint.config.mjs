...
// Keeps the UI browser-safe by restricting imports to types (and `toError`) from '@fius/core'.
          ...
          patterns: [
            {
              group: ['@fius/core/*'],
              message:
                'Do not use deep imports from @fius/core. Import from @fius/core directly - the browser bundle ensures only safe exports are available.',
            },
          ],
        },
      ],
