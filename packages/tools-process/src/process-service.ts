 ...
 * Process Service
 *
 * Secure command execution and process management for Fius internal tools
 */
...
export class ProcessService {
    ...
    constructor(config: ProcessConfig, logger: Logger) {
        ...
        this.logger = logger.createChild(FiusLogComponent.PROCESS);
    ...
    private resolveSafeCwd(cwd?: string): string {
        ...
        return path.isAbsolute(cwd) ? path.resolve(cwd) : path.resolve(baseDir, cwd);
    }
