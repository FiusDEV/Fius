...
export interface LLMTokensConsumedEvent {
    ...
    /** Reasoning tuning variant resolved for the call, when available. */
    reasoningVariant?: string | undefined;
    /** Reasoning budget tokens applied to the call, when provider options expose it. */
...
export interface SharedAnalyticsEventMap {
    fius_llm_tokens_consumed: LLMTokensConsumedEvent;
    fius_message_sent: MessageSentEvent;
    fius_tool_called: ToolCalledEvent;
    fius_tool_result: ToolResultEvent;
    fius_session_created: SessionCreatedEvent;
    fius_session_reset: SessionResetEvent;
    fius_llm_switched: LLMSwitchedEvent;
    fius_session_switched: SessionSwitchedEvent;
    fius_agent_switched: AgentSwitchedEvent;
    fius_mcp_server_connected: MCPServerConnectedEvent;
    fius_image_attached: ImageAttachedEvent;
    fius_file_rejected: FileRejectedEvent;
}
