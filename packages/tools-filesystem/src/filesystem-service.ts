 ...
 * FileSystem Service
 *
 * Secure file system operations for Fius internal tools
 */
...
export class FileSystemService {
    ...
    constructor(config: FileSystemConfig, logger: Logger) {
        ...
        this.logger = logger.createChild(FiusLogComponent.FILESYSTEM);
    ...
    private async readNormalizedFile(
        ...
        try {
            ...
            if (error instanceof FiusRuntimeError && error.scope === 'filesystem') {
                throw error;
            }
