...
export const PlanError = {
     ...
     */
    planAlreadyExists(sessionId: string): FiusRuntimeError {
     ...
     */
    planNotFound(sessionId: string): FiusRuntimeError {
        return new FiusRuntimeError(
     ...
     */
    sessionIdRequired(): FiusRuntimeError {
        return new FiusRuntimeError(
     ...
     * Invalid session ID (path traversal attempt)
     */
    invalidSessionId(sessionId: string): FiusRuntimeError {
        return new FiusRuntimeError(
     ...
     */
    checkpointNotFound(checkpointId: string, sessionId: string): FiusRuntimeError {
        return new FiusRuntimeError(
     ...
     * Storage operation failed
     */
    storageError(operation: string, sessionId: string, cause?: Error): FiusRuntimeError {
        return new FiusRuntimeError(
