...
export const PROVIDER_CONFIGS: Record<CustomModelProvider, ProviderConfig> = {
    ...
    openrouter: {
        ...
        asyncValidation: {
            field: 'name',
            validate: async (_modelId: string) => {
                // OpenRouter validation disabled - Fius uses models.dev instead
                return null;
            },
        },
    },
    ...
    'fius': {
        ...
        setupInfo: {
            title: 'Fius Setup',
            description:
                'Add OpenRouter-format models that use your Fius credits. Requires login: run `/login` first.',
