    ...
    deployCommand.option('--no-interactive', 'Disable interactive prompts').action(
        withAnalytics('deploy', async (options: { interactive?: boolean }) => {
            try {
                ...
                console.error(`вќЊ fius deploy command failed: ${err}`);
        ...
        .action(
            withAnalytics('deploy chat', async (cloudAgentId?: string) => {
                try {
                    ...
                    if (err instanceof ExitSignal) throw err;
                    console.error(`вќЊ fius deploy chat command failed: ${err}`);
        ...
        .action(
            withAnalytics('deploy list', async () => {
                try {
                    ...
                    if (err instanceof ExitSignal) throw err;
                    console.error(`вќЊ fius deploy list command failed: ${err}`);
        ...
        .action(
            withAnalytics('deploy open', async () => {
                try {
                    ...
                    if (err instanceof ExitSignal) throw err;
                    console.error(`вќЊ fius deploy open command failed: ${err}`);
        ...
        .action(
            withAnalytics('deploy status', async () => {
                try {
                    ...
                    if (err instanceof ExitSignal) throw err;
                    console.error(`вќЊ fius deploy status command failed: ${err}`);
        ...
        .action(
            withAnalytics('deploy stop', async () => {
                try {
                    ...
                    if (err instanceof ExitSignal) throw err;
                    console.error(`вќЊ fius deploy stop command failed: ${err}`);
        ...
        .action(
            withAnalytics('deploy delete', async (options: { interactive?: boolean }) => {
                try {
                    ...
                    if (err instanceof ExitSignal) throw err;
                    console.error(`вќЊ fius deploy delete command failed: ${err}`);
