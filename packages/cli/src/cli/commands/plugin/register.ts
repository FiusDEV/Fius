        ...
        .action(
            withAnalytics('plugin list', async (options: PluginListCommandOptionsInput) => {
                try {
                    ...
                    console.error(`вќЊ fius plugin list command failed: ${err}`);
        ...
        .action(
            withAnalytics('plugin install', async (options: PluginInstallCommandOptionsInput) => {
                try {
                    ...
                    if (err instanceof ExitSignal) throw err;
                    console.error(`вќЊ fius plugin install command failed: ${err}`);
        ...
        .action(
            withAnalytics('plugin uninstall', async (name: string) => {
                try {
                    ...
                    if (err instanceof ExitSignal) throw err;
                    console.error(`вќЊ fius plugin uninstall command failed: ${err}`);
        ...
        .action(
            withAnalytics('plugin validate', async (path?: string) => {
                try {
                    ...
                    if (err instanceof ExitSignal) throw err;
                    console.error(`вќЊ fius plugin validate command failed: ${err}`);
            ...
            withAnalytics(
                ...
                async (source: string, options: { name?: string }) => {
                    try {
                        ...
                        if (err instanceof ExitSignal) throw err;
                        console.error(`вќЊ fius plugin marketplace add command failed: ${err}`);
            ...
            withAnalytics(
                ...
                async (options: MarketplaceListCommandOptionsInput) => {
                    try {
                        ...
                        if (err instanceof ExitSignal) throw err;
                        console.error(`вќЊ fius plugin marketplace list command failed: ${err}`);
        ...
        .action(
            withAnalytics('plugin marketplace remove', async (name: string) => {
                try {
                    ...
                    if (err instanceof ExitSignal) throw err;
                    console.error(`вќЊ fius plugin marketplace remove command failed: ${err}`);
        ...
        .action(
            withAnalytics('plugin marketplace update', async (name?: string) => {
                try {
                    ...
                    if (err instanceof ExitSignal) throw err;
                    console.error(`вќЊ fius plugin marketplace update command failed: ${err}`);
            ...
            withAnalytics(
                ...
                async (marketplace?: string, options?: { verbose?: boolean }) => {
                    try {
                        ...
                        if (err instanceof ExitSignal) throw err;
                        console.error(`вќЊ fius plugin marketplace plugins command failed: ${err}`);
            ...
            withAnalytics(
                ...
                async (plugin: string, options: MarketplaceInstallCommandOptionsInput) => {
                    try {
                        ...
                        if (err instanceof ExitSignal) throw err;
                        console.error(`вќЊ fius plugin marketplace install command failed: ${err}`);
